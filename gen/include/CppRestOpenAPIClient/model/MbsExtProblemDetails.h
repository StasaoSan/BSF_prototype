...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_MbsExtProblemDetails_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_MbsExtProblemDetails_H_
...
///  Contains the FQDN or IP endpoints of the existing PCF and the cause value if there is an   existing PCF binding information for the MBS session.  
/// </summary>
class  MbsExtProblemDetails
    : public ModelBase
{
public:
    MbsExtProblemDetails();
    virtual ~MbsExtProblemDetails();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_MbsExtProblemDetails_H_ */
