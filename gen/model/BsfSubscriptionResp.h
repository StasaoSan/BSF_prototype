...
#ifndef BsfSubscriptionResp_H_
#define BsfSubscriptionResp_H_
...
/// It represents a response to a modification or creation request of an Individual Binding   Subscription resource. It may contain the notification of the already met events.  
/// </summary>
class  BsfSubscriptionResp : public BsfSubscription, public BsfNotification
{
public:
    BsfSubscriptionResp() = default;
    explicit BsfSubscriptionResp(boost::property_tree::ptree const& pt);
    virtual ~BsfSubscriptionResp() = default;

    BsfSubscriptionResp(const BsfSubscriptionResp& other) = default; // copy constructor
    BsfSubscriptionResp(BsfSubscriptionResp&& other) noexcept = default; // move constructor

    BsfSubscriptionResp& operator=(const BsfSubscriptionResp& other) = default; // copy assignment
    BsfSubscriptionResp& operator=(BsfSubscriptionResp&& other) noexcept = default; // move assignment
...
template<>
inline boost::property_tree::ptree toPt<BsfSubscriptionResp>(const BsfSubscriptionResp& val) {
    return val.toPropertyTree();
}

template<>
inline BsfSubscriptionResp fromPt<BsfSubscriptionResp>(const boost::property_tree::ptree& pt) {
    BsfSubscriptionResp ret;
