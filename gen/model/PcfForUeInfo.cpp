...
PcfForUeInfo::PcfForUeInfo(boost::property_tree::ptree const& pt)
{
        fromPropertyTree(pt);
}


std::string PcfForUeInfo::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
void PcfForUeInfo::fromJsonString(std::string const& jsonString)
{
...
ptree PcfForUeInfo::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PcfForUeInfo::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
std::string PcfForUeInfo::getPcfFqdn() const
{
    return m_PcfFqdn;
}

void PcfForUeInfo::setPcfFqdn(std::string value)
{
    m_PcfFqdn = value;
}


std::vector<IpEndPoint> PcfForUeInfo::getPcfIpEndPoints() const
{
    return m_PcfIpEndPoints;
}

void PcfForUeInfo::setPcfIpEndPoints(std::vector<IpEndPoint> value)
{
    m_PcfIpEndPoints = value;
}


std::string PcfForUeInfo::getPcfId() const
{
    return m_PcfId;
}

void PcfForUeInfo::setPcfId(std::string value)
{
    m_PcfId = value;
}


std::string PcfForUeInfo::getPcfSetId() const
{
    return m_PcfSetId;
}

void PcfForUeInfo::setPcfSetId(std::string value)
{
    m_PcfSetId = value;
}


BindingLevel PcfForUeInfo::getBindLevel() const
{
    return m_BindLevel;
}

void PcfForUeInfo::setBindLevel(BindingLevel value)
{
    m_BindLevel = value;
}
...
std::vector<PcfForUeInfo> createPcfForUeInfoVectorFromJsonString(const std::string& json)
{
    ...
    auto vec = std::vector<PcfForUeInfo>();
    for (const auto& child: pt) {
        vec.emplace_back(PcfForUeInfo(child.second));
    }
