...
void PcfMbsBinding::validate()
{
    // TODO: implement validation
}

web::json::value PcfMbsBinding::toJson() const
{

    web::json::value val = web::json::value::object();
    
    if(m_MbsSessionIdIsSet)
    {
        val[utility::conversions::to_string_t(U("mbsSessionId"))] = ModelBase::toJson(m_MbsSessionId);
    }
    if(m_PcfFqdnIsSet)
    {
...
bool PcfMbsBinding::fromJson(const web::json::value& val)
{
    bool ok = true;
    
    if(val.has_field(utility::conversions::to_string_t(U("mbsSessionId"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("mbsSessionId")));
        if(!fieldValue.is_null())
        {
            std::shared_ptr<MbsSessionId> refVal_setMbsSessionId;
            ok &= ModelBase::fromJson(fieldValue, refVal_setMbsSessionId);
            setMbsSessionId(refVal_setMbsSessionId);
        }
    }
...
void PcfMbsBinding::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_MbsSessionIdIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("mbsSessionId")), m_MbsSessionId));
    }
    if(m_PcfFqdnIsSet)
    {
...
bool PcfMbsBinding::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("mbsSessionId"))))
    {
        std::shared_ptr<MbsSessionId> refVal_setMbsSessionId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("mbsSessionId"))), refVal_setMbsSessionId );
        setMbsSessionId(refVal_setMbsSessionId);
    }
...
std::shared_ptr<MbsSessionId> PcfMbsBinding::getMbsSessionId() const
{
    return m_MbsSessionId;
}

void PcfMbsBinding::setMbsSessionId(const std::shared_ptr<MbsSessionId>& value)
{
    m_MbsSessionId = value;
    m_MbsSessionIdIsSet = true;
}

bool PcfMbsBinding::mbsSessionIdIsSet() const
{
    return m_MbsSessionIdIsSet;
}

void PcfMbsBinding::unsetMbsSessionId()
{
    m_MbsSessionIdIsSet = false;
}
utility::string_t PcfMbsBinding::getPcfFqdn() const
{
    return m_PcfFqdn;
}

void PcfMbsBinding::setPcfFqdn(const utility::string_t& value)
{
    m_PcfFqdn = value;
    m_PcfFqdnIsSet = true;
}

bool PcfMbsBinding::pcfFqdnIsSet() const
{
    return m_PcfFqdnIsSet;
}

void PcfMbsBinding::unsetPcfFqdn()
{
    m_PcfFqdnIsSet = false;
}
std::vector<std::shared_ptr<IpEndPoint>>& PcfMbsBinding::getPcfIpEndPoints()
{
    return m_PcfIpEndPoints;
}

void PcfMbsBinding::setPcfIpEndPoints(const std::vector<std::shared_ptr<IpEndPoint>>& value)
{
    m_PcfIpEndPoints = value;
    m_PcfIpEndPointsIsSet = true;
}

bool PcfMbsBinding::pcfIpEndPointsIsSet() const
{
    return m_PcfIpEndPointsIsSet;
}

void PcfMbsBinding::unsetPcfIpEndPoints()
{
    m_PcfIpEndPointsIsSet = false;
}
utility::string_t PcfMbsBinding::getPcfId() const
{
    return m_PcfId;
}

void PcfMbsBinding::setPcfId(const utility::string_t& value)
{
    m_PcfId = value;
    m_PcfIdIsSet = true;
}

bool PcfMbsBinding::pcfIdIsSet() const
{
    return m_PcfIdIsSet;
}

void PcfMbsBinding::unsetPcfId()
{
    m_PcfIdIsSet = false;
}
utility::string_t PcfMbsBinding::getPcfSetId() const
{
    return m_PcfSetId;
}

void PcfMbsBinding::setPcfSetId(const utility::string_t& value)
{
    m_PcfSetId = value;
    m_PcfSetIdIsSet = true;
}

bool PcfMbsBinding::pcfSetIdIsSet() const
{
    return m_PcfSetIdIsSet;
}

void PcfMbsBinding::unsetPcfSetId()
{
    m_PcfSetIdIsSet = false;
}
std::shared_ptr<BindingLevel> PcfMbsBinding::getBindLevel() const
{
    return m_BindLevel;
}

void PcfMbsBinding::setBindLevel(const std::shared_ptr<BindingLevel>& value)
{
    m_BindLevel = value;
    m_BindLevelIsSet = true;
}

bool PcfMbsBinding::bindLevelIsSet() const
{
    return m_BindLevelIsSet;
}

void PcfMbsBinding::unsetBindLevel()
{
    m_BindLevelIsSet = false;
}
utility::datetime PcfMbsBinding::getRecoveryTime() const
{
    return m_RecoveryTime;
}

void PcfMbsBinding::setRecoveryTime(const utility::datetime& value)
{
    m_RecoveryTime = value;
    m_RecoveryTimeIsSet = true;
}

bool PcfMbsBinding::recoveryTimeIsSet() const
{
    return m_RecoveryTimeIsSet;
}

void PcfMbsBinding::unsetRecoveryTime()
{
    m_RecoveryTimeIsSet = false;
}
utility::string_t PcfMbsBinding::getSuppFeat() const
{
    return m_SuppFeat;
}

void PcfMbsBinding::setSuppFeat(const utility::string_t& value)
{
    m_SuppFeat = value;
    m_SuppFeatIsSet = true;
}

bool PcfMbsBinding::suppFeatIsSet() const
{
    return m_SuppFeatIsSet;
}

void PcfMbsBinding::unsetSuppFeat()
{
    m_SuppFeatIsSet = false;
}
}
